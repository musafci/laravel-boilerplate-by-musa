<div class="row justify-content-md-center ">
    ...
    <div class="col-lg-4 col-4">
        <div class="form-group {{ $errors->has('is_parent') ? 'has-error' : '' }}">
            ...
            <select  id="isParent" name="is_parent" class="form-control" required>
...
<div class="row justify-content-md-center ">
    <div class="col-lg-8 col-8">
        <div class="form-group {{ $errors->has('parent_id') ? 'has-error' : '' }}">
            ...
            <select id="parentId" name="parent_id" class="form-control" required>
...
<div class="row justify-content-md-center">
    <div class="col-lg-4 col-4">
        <div class="form-group {{ $errors->has('icon') ? 'has-error' : '' }}">
            ...
            <input class="form-control" id="icon" type="file" name="icon" value="{{ old('icon', isset($category) ? $category->icon : null) }}" required>
            @if($errors->has('icon'))
    ...
    <div class="col-lg-4 col-4">
        <div class="form-group {{ $errors->has('banner') ? 'has-error' : '' }}">
            ...
            <input class="form-control" id="banner" type="file" name="banner" value="{{ old('banner', isset($category) ? $category->banner : null) }}" required>
