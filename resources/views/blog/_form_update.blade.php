            ...
            <select id="category_id" name="category_id" class="form-control">
                ...
                <?php
                    foreach ($categories as $categorie) {
                        $selected = ($categorie->id == $blog->category_id) ? 'selected' : '';
...
<div class="row justify-content-md-center ">
    ...
    <div class="col-lg-12 col-12">
        <div class="form-group {{ $errors->has('body') ? 'has-error' : '' }}">
            ...
            <textarea id="body" class="form-control" name="body" cols="5" rows="5">{{$blog->body}}</textarea>
            @if($errors->has('body'))
    ...
    <div class="col-lg-6 col-6">
        <div class="form-group">
            ...
            <select id="status" name="status" class="form-control">
                ...
                <option value="Unpublish" @if($blog->status == 'Unpublish') selected @endif>Unpublish</option>
            </select>
        </div>
    </div>
</div>
