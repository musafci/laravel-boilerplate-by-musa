{{--<div class="card-body">--}}
    <div class="table-responsive">
        <table id="ClosedTicketList" class="display table table-bordered table-striped table-hover list-data-view" style="width: 100%">
            <thead>
...
@section('scripts')
    ...
    <script>
        ...
        var dataTable2 = $('#ClosedTicketList').dataTable({
            "bProcessing": true,
            "serverSide": true,
            "order": [[0, "desc"]],
            "responsive": true,
